...
internal class TestTerrainTool : TerrainPaintTool<TestTerrainTool>
{
    ...
    [Shortcut("Nature Manufacture/Select TestTerrainTool", typeof(TerrainToolShortcutContext))]
    static void SelectShortcut(ShortcutArguments args)
    {
        // Get the TerrainTool-specifc context from the ShortcutArguments
        TerrainToolShortcutContext context = (TerrainToolShortcutContext)args.context;
        // Select this tool
        context.SelectPaintTool<TestTerrainTool>();
    }
        
    // Name of the Terrain Tool. This appears in the tool UI.
    public override string GetName()
    {
        return "Nature Manufacture/Test Terrain Tool";
    }

    // Description for the Terrain Tool. This appears in the tool UI.
    public override string GetDescription()
    {
        return "This is a Nature Manufacture Terrain Tool that modifies the Terrain heightmap.";
    }
    ...
    public override void OnRenderBrushPreview(Terrain terrain, IOnSceneGUI editContext)
    {
        ...
        UnityEngine.TerrainTools.BrushTransform brushXform = 
            UnityEngine.TerrainTools.TerrainPaintUtility.CalculateBrushTransform(terrain, editContext.raycastHit.textureCoord, m_BrushSize, m_BrushRotation);
    ...
    public override bool OnPaint(Terrain terrain, IOnPaint editContext)
    {
        // Get the current BrushTransform under the mouse position relative to the Terrain
        UnityEngine.TerrainTools.BrushTransform brushXform = 
            UnityEngine.TerrainTools.TerrainPaintUtility.CalculateBrushTransform(terrain, editContext.uv, m_BrushSize, m_BrushRotation);
